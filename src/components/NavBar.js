...
const NavBar = () => {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
    ...
    <div
      className={`w-full md:block md:w-auto ${showMobileMenu ? "block" : "hidden"}`}
      id="navbar-default"
    >
      <ul className="font-medium flex flex-col items-center p-2 md:p-0 mt-2 rounded-lg md:flex-row md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0">
        <li>
          <Link
            to="/home-one"
            className={`block py-2 px-2 text-gray-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 ${
