...
const Footer = () => {
  return (
    <footer className="bg-[#1E1E1E] px-5 lg:px-10 py-3  mt-5 lg:mt-10">
      <div className="container mx-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:gap-10">
        <div className="text-gray-500">
          ...
          <p className="text-sm text-white">
            ...
            letters, but also the leap into essentially unchanged. Lorem Ipsum
            is that it has a more-or-less normal distribution of letters, but
            also the leap into essentially unchanged. Ipsum is that it has a
            more.
          </p>
        </div>
      ...
      <div className="border-t border-[#0060B88A] py-1 mt-3">
        <div className="container mx-auto text-center text-white mt-3">
          <p className="">
            Copyright Fiza Engineering Corporation ©2023 | All Rights Reserved |
            Developed by{" "}
            <span className="text-[#0060B8]">ORBIT TECHNOLOGYS</span>
          </p>
        </div>
      </div>
    </footer>
