    ...
    <div className="relative w-full lg:h-screen overflow-hidden">
      <nav className="absolute w-full bg-transparent z-10">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className={`w-full md:block md:w-auto transition-all duration-300 ease-in-out ${isNavbarVisible ? 'block' : 'hidden'} md:hidden`} id="navbar-default">
            <ul className="font-medium flex flex-col items-center p-2 mt-2 rounded-lg bg-white text-gray-800">
              <li onMouseEnter={() => handleMouseEnter('/home-one')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/home-one"
                  className={`block py-2 px-3 rounded ${activeLink === "/home-one" ? "text-[#0060B8]" : "text-gray-500"}`}
                  aria-current="page"
                >
                  Home
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/about-us')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/about-us"
                  className={`block py-2 px-3 rounded ${activeLink === "/about-us" ? "text-[#0060B8]" : "text-gray-500"}`}
                  aria-current="page"
                >
                  About Us
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/services')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/services"
                  className={`block py-2 px-3 rounded ${activeLink === "/services" ? "text-[#0060B8]" : "text-gray-500"}`}
                  aria-current="page"
                >
                  Services
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/projects')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/projects"
                  className={`block py-2 px-3 rounded ${activeLink === "/projects" ? "text-[#0060B8]" : "text-gray-500"}`}
                  aria-current="page"
                >
                  Projects
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/contact-us')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/contact-us"
                  className={`block py-2 px-3 rounded ${activeLink === "/contact-us" ? "text-[#0060B8]" : "text-gray-500"}`}
                  aria-current="page"
                >
                  Contact Us
                </Link>
          ...
          <div className={`w-full md:block md:w-auto hidden md:flex md:space-x-8`}>
            <ul className="font-medium flex flex-row md:space-x-8 rtl:space-x-reverse text-white">
              <li onMouseEnter={() => handleMouseEnter('/home-one')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/home-one"
                  className={`block py-2 px-3 rounded ${activeLink === "/home-one" ? "text-[#0060B8]" : "text-[#0060B8]"}`}
                  aria-current="page"
                >
                  Home
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/about-us')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/about-us"
                  className={`block py-2 px-3 rounded ${activeLink === "/about-us" ? "text-[#0060B8]" : "text-white"}`}
                  aria-current="page"
                >
                  About Us
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/services')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/services"
                  className={`block py-2 px-3 rounded ${activeLink === "/services" ? "text-[#0060B8]" : "text-white"}`}
                  aria-current="page"
                >
                  Services
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/projects')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/projects"
                  className={`block py-2 px-3 rounded ${activeLink === "/projects" ? "text-[#0060B8]" : "text-white"}`}
                  aria-current="page"
                >
                  Projects
                </Link>
              ...
              <li onMouseEnter={() => handleMouseEnter('/contact-us')} onMouseLeave={handleMouseLeave}>
                <Link
                  to="/contact-us"
                  className={`block py-2 px-3 rounded ${activeLink === "/contact-us" ? "text-[#0060B8]" : "text-white"}`}
                  aria-current="page"
                >
                  Contact Us
                </Link>
