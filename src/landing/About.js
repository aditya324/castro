      ...
      <section className="bg-white p-1 ">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
          <div className="lg:mt-0 lg:col-span-5 lg:flex md:mt-10 ">
            <img
              className="lg:h-full lg:w-full w-72 object-cover rounded-lg lg:ml-12 ml-7 lg:mt-0 mt-4 md:ml-24"
              src={about}
              alt="mockup"
            />
            <div>
              <img
                className="absolute lg:top-full md:top-96 md:mt-36 md:w-44   lg:mt-1  lg:w-40 top-3/4 mt-32  lg:left-16 left-5 w-28 rotate"
                src={banner}
                alt=""
              />
              <h1 className="absolute lg:top-full md:top-96 md:mt-44 md:left-20 md:text-4xl lg:mt-10 mt-36  top-3/4 lg:left-30 lg:ml-7 left-14 font-bold  text-2xl text-white lg:text-5xl">
                20+
              </h1>
              <p className="absolute lg:top-full lg:ml-1  md:top-96 md:mt-56 md:left-14 md:text-2xl lg:mt-24 mt-44 top-3/4 lg:left-24 left-10 font-bold  text-base lg:text-xl text-white">
                Years Exp
              </p>
            </div>
          </div>
          <div className="mr-auto place-self-start lg:col-span-7 lg:pl-8 lg:ml-16 lg:mt-14 mt-8 lg:mb-5 md:p-5 md:ml-10">
