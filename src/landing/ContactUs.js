    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative lg:bottom-20 lg:ml-44 p-4">
        <div className="h-auto lg:h-[calc(100vh - 4rem)]">
          <section className="bg-white  h-full rounded-lg lg:w-full">
            <div className="py-8  px-4 mx-auto max-w-screen-md bg-white border border-gray-300 rounded-lg ">
              ...
              <form action="#" className="space-y-8 lg:h-80  lg:mb-10 ">
                ...
                <div className="flex justify-center mb-3">
                  <button
                    type="submit"
                    className=" h-10 px-5 text-sm font-medium text-center bg-[#0060B8] text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300"
                  >
                    Submit
                  </button>
                </div>
        ...
        <div className="bg-blue-500 p-8 rounded-lg h-auto lg:h-[calc(100vh - 4rem)] w-full lg:w-96 text-left">
          ...
          <button
            type="submit"
            className=" h-10 px-5 text-sm font-medium text-center bg-[#4499EA] text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 mt-5 w-full lg:w-48 lg:ml-16"
          >
            Contact us
          </button>
        </div>
